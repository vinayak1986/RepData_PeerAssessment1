...
```{r Histogram of the total no. of steps per day}
...
```{r Average no. of steps across 5-minute intervals}
...
```{r Histogram of the total number of steps taken per day using imputed data}
...
```{r Average no. of steps across 5-minute intervals on weekdays & weekends}
