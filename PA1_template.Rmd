...
```{r AverageNo.of.steps.across.5-minute.intervals}
...
```{r Hist.Total.No.Steps.Per.Day.using.imputed.data}
...
```{r Average.No.of.steps.across.5-minute.intervals.on.weekdays_weekends}
